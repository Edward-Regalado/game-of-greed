...
#   end of round = 0
#   for i in range(len(number of dice"answer")):
#     end of round += dice(LEFT) if int(number[i]) == answer[i] else end of turn

#   if end of ROUND == **SHELFED SCORE**:
#     print(end of round, Good job)
#     break

#   number of dice -= 1
#   print(done)
#   else:
#     print(maybe next time(No points)
